...
import ai.neopsyke.poc.cortex.MotorCortex
...
import ai.neopsyke.poc.superego.Superego
...
class Ego(
    ...
    private val actionQueue = ArrayDeque<ai.neopsyke.poc.model.ActionProposal>()

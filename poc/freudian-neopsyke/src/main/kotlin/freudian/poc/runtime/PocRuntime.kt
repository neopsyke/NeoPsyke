...
import freudian.poc.cortex.SensoryCortex
        ...
        for (tick in 0 until config.runtime.totalTicks) {
            ...
            processingResult.impulseFeedback.forEach { feedback ->
                ...
                when (feedback.result) {
                    freudian.poc.model.ImpulseResult.ACCEPTED -> impulsesAccepted += 1
                    freudian.poc.model.ImpulseResult.DENIED -> impulsesDenied += 1
                }
            }
        }

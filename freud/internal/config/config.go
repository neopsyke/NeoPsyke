...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("memory_live.enabled", d.MemoryLive.Enabled)
	v.SetDefault("memory_live.task_ids", d.MemoryLive.TaskIDs)
	v.SetDefault("memory_live.stage", d.MemoryLive.Stage)
	v.SetDefault("memory_live.max_attempts", d.MemoryLive.MaxAttempts)

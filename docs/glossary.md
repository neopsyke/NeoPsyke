...
- **Continuation** — Typed queued resumable work inside the Ego. Current variants are `PlanStepContinuation`, `RetryAlternative`, `ConvergeNow`, and `WaitResume`. `QueueModels.kt`

...
If the issue involves secrets, credentials, or customer data, do not include
real secrets in the report. Use redacted examples.
...
If a report is confirmed, fixes will generally be prepared privately first and
then disclosed once the patch is available or the risk has been otherwise
addressed.

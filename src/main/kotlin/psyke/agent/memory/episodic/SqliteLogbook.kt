 ...
 * Follows the same patterns as [psyke.metrics.SqliteMetricsRuntime]:
...
class SqliteLogbook(
    ...
    companion object {
        ...
        private const val DEFAULT_DB_RELATIVE_PATH: String = ".psyke/logbook.db"
        ...
        fun resolveDbPath(configured: String): Path {
            ...
            val fromProperty = System.getProperty("psyke.logbook.db")

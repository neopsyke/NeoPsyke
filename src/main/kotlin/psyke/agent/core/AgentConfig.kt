            ...
            return AgentConfig(
                ...
                memory = MemoryConfig(
                    ...
                    taskWorkspace = TaskWorkspaceConfig(
                        ...
                        digestMaxEntries = readInt("EGO_TASK_WORKSPACE_DIGEST_MAX_ENTRIES", 4),
                        digestMaxChars = readInt("EGO_TASK_WORKSPACE_DIGEST_MAX_CHARS", 800),
                        digestMaxPromptTokens = readInt("EGO_TASK_WORKSPACE_DIGEST_MAX_PROMPT_TOKENS", 160),
                    ),
                ...
                logbook = LogbookConfig(
                    enabled = readBoolean("PSYKE_LOGBOOK_ENABLED", true),
                    maxSummaryChars = readInt("PSYKE_LOGBOOK_MAX_SUMMARY_CHARS", LogbookConfig.DEFAULT_MAX_SUMMARY_CHARS),
                    maxKeywordsPerEntry = readInt("PSYKE_LOGBOOK_MAX_KEYWORDS", LogbookConfig.DEFAULT_MAX_KEYWORDS_PER_ENTRY),
                    maxEntriesPerQuery = readInt("PSYKE_LOGBOOK_MAX_ENTRIES_PER_QUERY", LogbookConfig.DEFAULT_MAX_ENTRIES_PER_QUERY),
                    retentionDays = readInt("PSYKE_LOGBOOK_RETENTION_DAYS", LogbookConfig.DEFAULT_RETENTION_DAYS),
                    episodicRecallMaxChars = readInt("PSYKE_LOGBOOK_EPISODIC_RECALL_MAX_CHARS", LogbookConfig.DEFAULT_EPISODIC_RECALL_MAX_CHARS),
                    episodicRecallMaxResults = readInt("PSYKE_LOGBOOK_EPISODIC_RECALL_MAX_RESULTS", LogbookConfig.DEFAULT_EPISODIC_RECALL_MAX_RESULTS),
                    useLlmSummarizer = readBoolean("PSYKE_LOGBOOK_USE_LLM_SUMMARIZER", false),
                ),

...
class MemoryLiveEvalRunner(
    ...
    private fun buildConsolidationContext(
        ...
        return LongTermMemoryAssessmentContext(
            ...
            metaGuidance = "Prefer storing durable user/assignment memory for future recall."
        )
    }

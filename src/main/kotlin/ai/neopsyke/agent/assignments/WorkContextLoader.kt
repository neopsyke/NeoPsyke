...
object WorkContextLoader {
    private const val ASSIGNMENT_RUNTIME_PROVIDER: String = "assignment-runtime"
    ...
    /**
     * Build a [AssignmentActivation] for the Ego to process.
     */
    fun buildWorkUnit(
        state: WorkItemState,
        step: PlanStep,
        ...
        val baseSecurity = ConversationSecurityContexts.internalAutomation(
            provider = ASSIGNMENT_RUNTIME_PROVIDER,
            channelId = "",
        )
        ...
        return AssignmentActivation(
            ...
            conversationContext = ConversationContext(
                ...
                interlocutor = Interlocutor.named(ASSIGNMENT_RUNTIME_PROVIDER),
                security = security,
            ),
    ...
    /**
     * Write Tier 2 `context.md` at the end of an assignment cycle.
     *
     ...
     * detailed content. The Ego calls this via AssignmentRuntime after each

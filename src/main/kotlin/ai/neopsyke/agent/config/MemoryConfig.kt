...
data class MemoryConfig(
    ...
    val longTermMemoryMaxTokens: Int = 1024,
    val longTermMemoryDynamicCompletionEnabled: Boolean = true,
    val longTermMemoryDynamicCompletionHardMaxTokens: Int = 2048,
    val longTermMemoryDynamicPromptToCompletionRatio: Double = 0.08,
    val longTermMemoryDynamicCompletionMinPromptTokens: Int = 160,
